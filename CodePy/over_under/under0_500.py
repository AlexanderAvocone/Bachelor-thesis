...
if __name__ == "__main__":
    df = load_parquet("/ceph/aavocone/Datasets/0_large.parquet")
    ...
    xtrain,xval,ytrain,yval = train_test_split(xunder, yunder, test_size = 0.33, stratify = yunder)
    ...
    model.save_model(f"/ceph/aavocone/models/under0_{estimator}.txt")